...
class NotificationService: IntentService("NotificationService") {
    ...
    private fun createChannel() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            notificationChannel.description = "This is notification description" //getString(R.string.notification_channel_description)
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (timestamp > 0) {
            ...
            val notifyIntent = Intent(this, WeatherListingActivity::class.java)

            val title = "Weather Alert"
            val message = "Temprature is changing in your area!"
